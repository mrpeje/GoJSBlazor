...
// In this project, Index.razor calls it from within OnAfterRender in Index.razor.cs dasdasdasd
function initGoJS() {
...
function selectBlockById() {
    const node = myDiagram.findNodeForKey("Beta");
